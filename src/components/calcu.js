        ...
        <div className="bg-[#17171C] dark:bg-[#F1F2F3] mx-auto flex flex-col justify-between max-w-[375px] h-[712px] mb-9 text-white dark:text-black px-5 rounded-lg">
          ...
          <div className="flex flex-col gap-4 items-center">
            ...
            <div className="grid grid-cols-4 gap-4 mx-auto text-[32px]">
              <button
                onClick={clean}
                className="bg-[#4E505F] dark:bg-[#D2D3DA] rounded-[24px] p-[12px] cursor-pointer hover:brightness-150 text-white text-center w-[72px]"
              >
                c
              </button>
              <button className="bg-[#4E505F] dark:bg-[#D2D3DA] rounded-[24px] p-[12px] cursor-pointer hover:brightness-150 text-white text-center w-[72px]">
                <span>
              ...
              <button
                name="/"
                onClick={handleClick}
                className="bg-[#4B5EFC] rounded-[24px] p-[12px] cursor-pointer hover:brightness-150 text-white text-center w-[72px]"
              >
                ÷
              </button>
              <button
                name="7"
                onClick={handleClick}
                className="bg-[#2E2F38] dark:bg-[#FFFFFF] rounded-[24px] p-[12px] cursor-pointer hover:brightness-150 text-white text-center w-[72px]"
              >
                7
              </button>
              <button
              ...
              <button
                onClick={backspace}
                className="bg-[#2E2F38] dark:bg-[#FFFFFF] rounded-[24px] p-[12px] cursor-pointer hover:brightness-150 text-white w-[72px]"
              >
                <span>
